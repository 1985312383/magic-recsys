...
刚开始了解推荐系统的人，很容易把它和搜索引擎搞混——毕竟两者都是从海量信息里找内容。但它们的核心区别在于**意图的主动性**。

![](/img/ch01/search_vs_reco_summary.png)
*搜索 vs 推荐：主动检索 vs 被动分发*

*   **搜索引擎（Search）**：解决的是 **“人找信息”** 。你明确知道自己要什么（比如“北京明天天气”），主动输入关键词，系统基于 **相关性** 返回结果。它不仅是个工具，更像是在回应你的直接提问。
*   **推荐系统（Recommendation）**：解决的是 **“信息找人”** 。你不确定自己要什么（比如“随便刷刷”），系统通过分析你的历史行为（点击、收藏、停留），基于 **偏好** 主动推送内容。它像个贴心管家，在你开口前就猜到了你的心思。

两者并不是对立的，而是互补的。搜索满足明确需求，推荐挖掘潜在兴趣。在现在的 App 里，它们往往协同工作——搜过“咖啡壶”的人，推荐流里会出现“咖啡豆”，共同覆盖了我们获取信息的全部场景。
